...
def send_request(data, proxies=None):
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://confirmsubscription.com/h/y/83E69D5C3F00A47B',
    ...
    request_data = {
        "fields": [
            {"id": "fieldEmail", "type": "Email", "value": [data['email']]},
            {"id": "fieldtyduhru", "type": "Text", "value": [data['project']]}
        ],
        "referrer": "https://www.cambrian.org/",
    ...
    try:
        ...
        response = requests.post('https://confirmsubscription.com/t/y/HostedSubscribeForm/tjjdgj',
                              headers=headers,
                              json=request_data,
                              proxies=proxy_dict)
